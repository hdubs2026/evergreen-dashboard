 ...
 */
export declare const BASE_EXPONENTIAL_BACKOFF_MS = 1000;
/**
 ...
 */
export declare function calculateErrorBackoffMs(baseInterval: number, errorCount: number): number;
/**
 ...
 */
export declare function calculateExponentialBackoffMs(attempt: number, baseDelayMs?: number): number;
/**
