...
import { Brain, Database, FileText, RefreshCw, Clock, HardDrive, CheckCircle } from 'lucide-react'
...
const activityFeed = [
  {
    ...
    type: 'checkpoint',
    typeColor: 'text-emerald-600 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-900/20',
  ...
  },
  {
    ...
    type: 'decision',
    typeColor: 'text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/20',
  ...
  },
  {
    ...
    agentColor: 'bg-emerald-500',
    type: 'log',
    typeColor: 'text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800',
  ...
  },
  {
    ...
    type: 'checkpoint',
    typeColor: 'text-emerald-600 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-900/20',
    content: 'System health check passed. All 5 integrations operational. Google Sheets latency elevated at 520ms — monitoring.',
    time: '12:00 PM',
    timeAgo: '2h ago',
  },
  {
          ...
          <div className="rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
            <div className="divide-y divide-gray-50 dark:divide-gray-800">
              {activityFeed.map((entry, i) => (
                <div
                  key={i}
                  className="p-4 flex items-start gap-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors"
                >
                  <div
                    className={`mt-0.5 h-6 w-6 rounded-full ${entry.agentColor} flex items-center justify-center shrink-0`}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span
                        className={`inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium ${entry.typeColor}`}
                      >
                        {entry.type}
                      </span>
                    </div>
